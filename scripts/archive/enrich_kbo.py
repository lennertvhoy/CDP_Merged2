...
class AzureOpenAIEnricher:
    ...
    def __init__(self, endpoint: Optional[str] = None, api_key: Optional[str] = None, deployment: str = "gpt-5"):
    ...
    def _load_from_env(self):
        ...
        self.deployment = self.deployment or os.getenv('AZURE_OPENAI_DEPLOYMENT', 'gpt-5')
